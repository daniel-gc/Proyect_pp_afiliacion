...
//			}
	...
	public void sendEmailWithAttachment(String text, String subject, String to, ByteArrayOutputStream reporte) {
		...
		try {
			...
			adjunto.setContent(reporte, "Certificado Funerario");
                        adjunto.setFileName("CertificadoFunerario.pdf");
